...
// p.setAttribute('for' ,"kensaku");
// p.textContent = '検索:';
// div.insertAdjacentElement('beforeend', p);

// let p1 = document.createElement('input');
// p1.setAttribute('type', "search");
// p1.setAttribute('name', "kensaku");
// p1.setAttribute('id', "kensaku");
// p1.setAttribute('size', "10");
// div.insertAdjacentElement('beforeend', p1);

// let p2 = document.createElement('button');
// p2.setAttribute('id', "print");
// p2.textContent = '表示';
// div.insertAdjacentElement('beforeend', p2);
// p2.addEventListener('click', greeting);
...
// console.log("予算: " + data.results.shop[0].budget.average);
...
// console.log("予算: " + data.results.shop[1].budget.average);
...
//     let kensaku = i.value;       // ユーザが記入した文字列
